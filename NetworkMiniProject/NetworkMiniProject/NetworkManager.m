...
-(void)contentsPost:(NSString *)token contents:(NSDictionary *)contentsDic completion:(CompletionBlock)completion{
    
    NSString *urlString = [NSString stringWithFormat:@"%@", POST_API];
    NSString *authURL = [NSString stringWithFormat:@"%@ %@",@"Token",token];

    NSMutableDictionary *bodyParameters = [[NSMutableDictionary alloc] init];
    NSString *title = [contentsDic objectForKey:@"title"];
    NSString *content = [contentsDic objectForKey:@"content"];
    NSData *img_cover_data = [contentsDic objectForKey:@"img_cover"];

    
    [bodyParameters setObject:title forKey:@"title"];
    [bodyParameters setObject:content forKey:@"content"];
    [bodyParameters setObject:img_cover_data forKey:@"img_cover"];
    ...
    [formData appendPartWithFileData:img_cover_data name:@"img_cover" fileName:@"fileimage.png" mimeType:@"image/png"];
